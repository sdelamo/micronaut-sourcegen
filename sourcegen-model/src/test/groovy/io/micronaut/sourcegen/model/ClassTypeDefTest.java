...
//        Assertions.assertEquals(annotatedClassTypeDef, typeDef);
    ...
    @Test
    void testNullabilityIsUsedForEquals() {
...
//        Assertions.assertEquals(typeDefNotNull.hashCode(), annotatedClassTypeDef.hashCode());
        ...
        Assertions.assertNotEquals(typeDefNullable, classTypeDef);
        Assertions.assertNotEquals(typeDefNullable, className);
        Assertions.assertNotEquals(typeDefNullable, classElementType);
...
//        Assertions.assertEquals(typeDefNotNull, annotatedClassTypeDef);
        ...
        Assertions.assertNotEquals(classTypeDef, typeDefNullable);
        Assertions.assertNotEquals(className, typeDefNullable);
        Assertions.assertNotEquals(classElementType, typeDefNullable);
